...
/**
 *
 * @param {number} opposite Trigonomentic opposite length
 * @param {number} adjacent Trigonomentic adjacent length
 * @return {number} rotation in degrees
 */
exports.calculateAtanDeg = function (opposite, adjacent) {
